...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        if (!data) {
            setFormError("Something went wrong while generating your report. Please try again.")
            return
        }
    ...
    // Skip the full-page loading screen while we're generating a report —
    // the button itself shows a spinner so the form stays visible.
        ...
        <div className='home-page'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className={`dropzone ${resumeFileName ? 'dropzone--filled' : ''}`} htmlFor='resume'>
                                ...
                                <span className='dropzone__icon'>
                                    {resumeFileName ? (
                                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 12l2 2 4-4" /><circle cx="12" cy="12" r="10" /></svg>
                                    ) : (
                                ...
                                <p className='dropzone__subtitle'>{resumeFileName ? 'Click to choose a different file' : 'PDF or DOCX (Max 5MB)'}</p>
                                <input
                                    ref={resumeInputRef}
            ...
            <footer className='page-footer'>
                ...
                <p className='page-footer__copyright'>
                    &copy; {new Date().getFullYear()} JobReadyAI. Made with <span className='page-footer__heart'>&hearts;</span> for job seekers everywhere.
                </p>
            </footer>
        </div>
    )
